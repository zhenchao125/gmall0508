package com.atguigu.gmall0508.mock


import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.atguigu.gmall0508.common.util.{RandomNumUtil, RandomOptions}
import com.atguigu.gmall0508.mock.util.LogUploader
...
object JsonMock {
    ...
    val eventOpts = RandomOptions(
        ...
        ("addCart", 20), ("clickItem", 40), ("coupon", 70))
